...
function StudioPreview() {
  return <div className="landing-stage-v2" aria-label="Vista conceptual del estudio Ascend">
    <div className="landing-stage-shell">
      ...
      <div className="landing-stage-body">
        ...
        <div className="landing-stage-canvas"><div className="landing-image-placeholder"><span>Ascend / Editorial 01</span><strong>Precisión creativa para cada producto.</strong><small>4:5 · Gemini Image</small></div><div className="landing-stage-focus"><span/>Dirección consistente</div></div>
...
export default function Home() {
  return <><Nav/><main className="landing-v2">
    <section className="landing-hero-v2">
      <div className="landing-hero-mesh"/>
      <div className="landing-copy-v2">
        ...
        <div className="landing-actions-v2"><Link className="btn landing-primary-action" href="/register">Abrir mi estudio <span>↗</span></Link><Link className="landing-secondary-action" href="/login">Ya tengo una cuenta</Link></div>
        <div className="landing-proof-v2"><span><i/>Briefs estructurados</span><span><i/>Marca consistente</span><span><i/>Generación trazable</span></div>
      </div>
      <StudioPreview/>
    </section>
    ...
    <section className="landing-capability-v2" aria-label="Capacidades de Ascend">{capabilities.map(([number, title, description]) => <article key={number}><span>{number}</span><div className="landing-capability-line"/><h3>{title}</h3><p>{description}</p></article>)}</section>
